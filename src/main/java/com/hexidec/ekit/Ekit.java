...
com.hexidec.ekit.Ekit - Java Swing HTML Editor & Viewer
...
public class Ekit extends JFrame
{
	...
	public Ekit()
	{
		this(null, null, null, null, true, false, true, true, null, null, false, false, false, true, false, "Ekit");
	}
	...
	{
		System.out.println("usage: Ekit [-t|t+|T] [-s|S] [-m|M] [-x|X] [-b|B] [-v|V] [-p|P] [-fFILE] [-cCSS] [-rRAW] [-uURL] [-lLANG] [-d|D] [-h|H|?]");
