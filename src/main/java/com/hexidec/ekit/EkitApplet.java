...
com.hexidec.ekit.EkitApplet - Java Swing HTML Editor & Viewer Applet
...
public class EkitApplet extends JApplet
{
	...
	public void init()
	{
		...
		{
			EkitCore = new EkitCore(true, sRawDocument, urlCSS, showToolBar, showViewSource, showMenuIcons, editModeExclusive, sLanguage, sCountry, base64, false, showToolBarMulti, toolbarSeq, enterBreak, "Ekit");
		}
