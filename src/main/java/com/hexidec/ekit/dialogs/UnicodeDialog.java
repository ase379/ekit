...
*/
	...
	UnicodeDialog(EkitCore parent, String title, boolean bModal, int index)
	{
	...
	public void init(int startIndex)
	{
		...
		for(int counter = 0; counter < UNICODEBLOCKSIZE; counter++)
		{
			...
			buttonArray[counter].setBorder(javax.swing.BorderFactory.createEtchedBorder(EtchedBorder.LOWERED));
