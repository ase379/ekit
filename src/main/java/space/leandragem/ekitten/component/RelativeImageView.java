...
public class RelativeImageView extends View implements ImageObserver, MouseListener, MouseMotionListener
{
	...
	private static final String PENDING_IMAGE_SRC = "com/hexidec/ekit/icons/ImagePendingHK.gif";
	private static final String MISSING_IMAGE_SRC = "com/hexidec/ekit/icons/ImageMissingHK.gif";
	...
	*/
	...
	{
		fGrowBase = null;
		//! Should post some command to make the space.leandragem.ekitten.action undo-able
	}
	...
	private void loadImageStatusIcons()
	{
		...
		{
			System.err.println("ImageView : Couldn't load image com.hexidec.ekit.icons");
		}
	}
