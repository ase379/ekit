...
public class UserInputDialog extends JDialog
{
	...
	UserInputDialog(Frame parent, String title, boolean bModal, String attribName, String defaultText)
	{
	...
	UserInputDialog(Frame parent, String title, boolean bModal, String attribName)
	{
